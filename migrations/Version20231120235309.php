 ...
 */
final class Version20231120235309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD user_id INT DEFAULT NULL, ADD type VARCHAR(255) NOT NULL, ADD questions JSON NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game DROP user_id, DROP type, DROP questions');
    }
}
